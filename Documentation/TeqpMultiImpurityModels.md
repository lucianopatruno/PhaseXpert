...
| CO₂+CH₄ | Ghafri et al. 2016 NIST ThermoML density matrix is encoded and fully classified; the 301.14 K gas block and 308.15-313.15 K high-temperature supercritical slice are production-enabled for density only | Petropoulou et al. 2018, DOI `10.1016/j.fluid.2018.01.011`, reports CO₂+CH₄ VLE near 293-303 K; the corrected diagnostic bridge converges 37/37 rows with 0.585602% ordinary-row pressure AARD and 1.787018% worst pressure deviation | Current production CH₄ support is limited to EOS-CG/Ghafri homogeneous density only; VLE remains diagnostic until phase-envelope continuation and provider gating are complete. |
...
| CH₄ | EOS-CG-2021 inherited GERG pair | Ghafri et al. 2016 NIST ThermoML density; Petropoulou et al. 2018 corrected VLE diagnostic | full 180-row matrix converged but broad support failed: 1.3981775% AARD, 5.15195% worst; gas block pass: 6/6 points, 0.2034228% AARD, 0.413175% worst; high-temperature supercritical slice pass: 65 points, 1.1254775% AARD, 1.99333% worst | diagnostic only: 37/37 Petropoulou rows converged, ordinary pressure AARD 0.585602%, worst pressure 1.787018%; phase equilibrium unavailable in production | xCH₄ = 0.05 exactly; 301.133-301.153 K and 1.99046-6.976 MPa; plus encoded 308.15-313.15 K high-temperature supercritical isotherm pressure bounds | no |
