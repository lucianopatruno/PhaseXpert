...
| CO₂+CH₄ | Ghafri et al. 2016 NIST ThermoML density matrix is encoded and fully classified; the 301.14 K gas block and 308.15-313.15 K high-temperature supercritical slice are production-enabled for density | Petropoulou et al. 2018, DOI `10.1016/j.fluid.2018.01.011`, reports CO₂+CH₄ VLE near 293-303 K; the corrected bridge converges 37/37 rows, and the production gate accepts 24 ordinary 293.13 K/298.14 K rows with 0.608899% pressure AARD and 1.787018% worst pressure deviation | Current production CH₄ support is limited to EOS-CG/Ghafri homogeneous density plus exact xCH₄ = 0.05 Petropoulou phase classification and bubble/dew points; critical termination and arbitrary composition interpolation remain unavailable. |
...
| CH₄ | EOS-CG-2021 inherited GERG pair | Ghafri et al. 2016 NIST ThermoML density; Petropoulou et al. 2018 corrected VLE | full 180-row matrix converged but broad support failed: 1.3981775% AARD, 5.15195% worst; gas block pass: 6/6 points, 0.2034228% AARD, 0.413175% worst; high-temperature supercritical slice pass: 65 points, 1.1254775% AARD, 1.99333% worst | limited production gate: 24 accepted ordinary Petropoulou rows at 293.13 K and 298.142 K, pressure AARD 0.608899%, worst pressure 1.787018%, worst yCH₄ 0.026258 | xCH₄ = 0.05 exactly; density at 301.133-301.153 K and 1.99046-6.976 MPa plus 308.15-313.15 K high-temperature supercritical isotherm pressure bounds; VLE classification and continuous bubble/dew envelope from 293.13 K to 298.142 K only | 82-point continuous bubble/dew segment; no validated critical marker |
