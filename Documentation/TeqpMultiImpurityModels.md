...
| `teqp-v0.23.1-eoscg2021-co2-ch4-gas-density-ghafri2016` | CO₂+CH₄ | EOS-CG-2021 / inherited GERG pair | production-enabled, limited pass | homogeneous gas density at xCH₄ = 0.05 plus molar mass, specific volume, Z | no |
...
| CO₂+CH₄ | CO₂ `Span-JPCRD-1996`; CH₄ `Setzmann-JPCRD-1991` | `Kunz-JCED-2012`, `F=1`, `betaT=1.02262449`, `gammaT=0.975665369`, `betaV=0.999518072`, `gammaV=1.002806594` | `Methane-CarbonDioxide`, GERG-2008, `Kunz-JCED-2012` | standard multifluid; GERG residual; EOS-CG-2021 inherited GERG pair | EOS-CG-2021 limited homogeneous gas-density support enabled at the Ghafri 2016 gas-block domain after beta/gamma mapping correction |
...
| CO₂+CH₄ | Ghafri et al. 2016 NIST ThermoML density matrix is encoded and fully classified for this milestone | Petropoulou et al. 2018, DOI `10.1016/j.fluid.2018.01.011`, reports CO₂+CH₄ VLE near 293-303 K; the earlier direct VLE diagnostic is superseded by the CH₄ mapping correction and is not production evidence | Current production CH₄ support is limited to EOS-CG/Ghafri homogeneous gas density only. |
...
| CH₄ | EOS-CG-2021 inherited GERG pair | Ghafri et al. 2016 NIST ThermoML density; Petropoulou et al. 2018 historical VLE diagnostic retained as superseded | full 180-row matrix converged but broad support failed: 1.3981775% AARD, 5.15195% worst; gas block limited pass: 6/6 points, 0.2034228% AARD, 0.413175% worst | no audited corrected VLE matrix; phase equilibrium unavailable | xCH₄ = 0.05 exactly, T = 301.14 K ± 0.02 K, 1.99046-6.976 MPa only | no |
