...
| CO₂+CH₄ | Corrected GERG-inherited reducing parameters plus GERG-2008 departure function | 37 Petropoulou 2018 VLE rows; 24 ordinary rows accepted for the fixed production gate; 46 diagnostic continuation points planned across 293.13-303.145 K | 0.416664% pressure overall; 0.608899% pressure for accepted ordinary production rows | 1.787018% pressure; 0.026258 absolute yCH₄ | Limited VLE production gate for exact xCH₄ = 0.05 at 293.13 K and 298.14 K; diagnostic continuous branch tracing and fixed-composition critical solver implemented but critical termination and arbitrary composition interpolation unavailable |
